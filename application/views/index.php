...
<body>
        ...
        <div id="floating-button" class="float">
            <div class="control-center open">
                ...
                <ul class="right-sidebar">
                    <!--gallery-->
                    <li onclick="scrollToElement('fh5co-health-protocol')"
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2 text-center fh5co-heading animate-box">
                            ...
                            <p style="color: #bf9b73">Tanpa mengurangi rasa hormat, Kami mengundang Anda <br> Untuk
                                hadir di Acara Pernikahan Kami</p>
                            <button class="btn btn-primary" id="open-invitation" style="display: none;">Terima
                                Undangan</button>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-8 col-md-offset-2 text-center fh5co-heading animate-box">
                        ...
                        <br>
                        <p>
                            <a href="https://calendar.google.com/calendar/event?action=TEMPLATE&tmeid=NjI5OTl0dTcwcDRwa3ExcGlqOWxlZjNsaHQgdGkxOGZhdGFhLjAwMTBAbQ&tmsrc=ti18fataa.0010%40gmail.com"
                        ...
                        <div class="desc-groom">
                            ...
                            <div id="social-media-dian">
                                <ul class="fh5co-social-icons">
                                    <li><a target="_blank" href="https://www.instagram.com/diaann.o/"><i
                    ...
                    <div class="couple-half">
                        ...
                        <div class="desc-bride">
                            ...
                            <div id="social-media-molid">
                                <ul class="fh5co-social-icons">
                                    <li><a target="_blank" href="https://github.com/coldalpha"><i
                                                class="icon-github-with-circle"></i></a></li>
                                    <li><a target="_blank" href="https://www.instagram.com/cold.alpha/"><i
                                                class="icon-instagram-with-circle"></i></a></li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="col-md-10 col-md-offset-1">
                        <div class="col-md-6 col-sm-6 text-center">
                            <div class="event-wrap animate-box">
                                ...
                                <p style="font-family: 'Courgette', Arial, serif">Alamat : Kediaman mempelai putri,
                                    Tirto, Pekalongan </p>

                                <a href="https://maps.app.goo.gl/VuS8JKyBntrZLH4x5" target="_blank"
                        ...
                        <div class="col-md-6 col-sm-6 text-center">
                            <div class="event-wrap animate-box">
                                ...
                                <a href="https://maps.app.goo.gl/DHN6tiqbpJ8rbYf48" target="_blank"
                                    class="btn btn-primary">Penunjuk Lokasi <i class="icon-map2"></i></a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row animate-box">
                    ...
                    <div class="col-md-8 col-md-offset-2 text-center">
                        <div class="row">
                                ...
                                <div class="item-protocol">
                                    <div class="icon">
                                        <img style="padding: 10px" height="90px" width="90px"
                                            src="images/health-protocol/adabPakaian.png" alt="Adab makan minum" />
                                    </div>
                                ...
                                <div class="item-protocol">
                                    <div class="icon">
                                        <img style="padding: 15px" height="100px" width="100px"
                                            src="images/health-protocol/eating.png" alt="Jaga jarak" />
                                    </div>
                                    <div class="description">
                                        <h3>Makan & Minum</h3>
                            ...
                            <div class="col-md-4 col-xs-6">
                                <div class="item-protocol">
                                    <div class="icon">
                                        <img style="padding: 15px" height="100px" width="100px"
                                            src="images/health-protocol/adabBerbicara.png" alt="Jaga jarak" />
                                    </div>
                                    <div class="description">
                                        <h3>Menjaga Lisan</h3>
                            ...
                            <div class="col-md-4 col-xs-6">
                                <div class="item-protocol">
                                    <div class="icon">
                                        <img style="padding: 15px" height="100px" width="100px"
                                            src="images/health-protocol/adabDoa.png" alt="Jaga jarak" />
                                    </div>
                                    <div class="description">
                                        <h3>Berdoa</h3>
                        ...
                        <p style="color: #bf9b73">Para tamu undangan yang hadir berkenan menerapkan protokol kesehatan :
                        </p>
                        <div class="row">
                            <div class="col-md-4 col-xs-6">
                                <div class="item-protocol">
                            ...
                            <div class="col-md-4 col-xs-6">
                                <div class="item-protocol">
                                    <div class="icon">
                                        <img style="padding: 10px" height="90px" width="90px"
                                            src="images/health-protocol/washing-hands.png" alt="Cuci Tangan" />
                                    </div>
                                    <div class="description">
                                        <h3>Cuci Tangan</h3>
                            ...
                            <div class="col-md-4 col-xs-6">
                                <div class="item-protocol">
                                    <div class="icon">
                                        <img style="padding: 10px" height="90px" width="90px"
                                            src="images/health-protocol/shaking-hands.png" alt="Tidak Bersalaman" />
                                    </div>
                                    <div class="description">
                        ...
                        <div id="form-container">
                            <form id="ucapan-form">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="ucapan" rows="4" placeholder="Ucapan Anda"
                                        required></textarea>
                                </div>
                                <div id="button-send" class="text-center animate-box">
                                    <button type="submit" class="btn btn-primary btn-sm">Kirim Ucapan Untuk
                                        Pengantin</button>
                                </div>
                            </form>
                        </div>
            ...
            <div class="container">
                <div class="row animate-box">
                    <div class="col-md-8 col-md-offset-2 text-center">
                        ...
                        <i style="font-size: 15px">Doa Restu Anda merupakan karunia yang sangat berarti bagi kami. dan
                            jika memberi adalah ungkapan tanda kasih Anda, Anda dapat memberi kado secara cashless.</i>
                    </div>
                    <div class="col-md-8 col-md-offset-2 text-center">
                ...
                <div class="row copyright animate-box">
                    <div class="col-md-12 text-center">
                        ...
                        <p>
                            ...
                            <small>Instagram : cold.alpha | Whatsapp : (+62) 895-3771-17145 |
                                coldalpha.github.io</small>
                        <ul class="fh5co-social-icons">
                            <li><a target="_blank" href="https://wa.me/62895377117145/"><i class="icon-phone"></i></a>
                            </li>
                            <li><a target="_blank" href="https://coldalpha.github.io/"><i class="icon-globe"></i></a>
                            </li>
                            <li><a target="_blank" href="https://www.instagram.com/cold.alpha/"><i
                                        class="icon-instagram"></i></a></li>
                            <li><a target="_blank" href="https://github.com/coldalpha"><i class="icon-github"></i></a>
                            </li>
                        </ul>
                        </p>
                    </div>
            ...
            for (let i = 0; i < pageData.length; i++) {
                ...
                const item = `
                    ...
                    <div class="list-group-item ucapan-item">
						<div class="name"><span class="strong" style="font-size: 15px">Pengirim : ${pageData[i].nama}</span></div>
		       			<hr style="margin-top: 0;">
		             	<div class="comment">Ucapan : ${new showdown.Converter().makeHtml(pageData[i].kata_ucapan)}</div>			                        
                    </div>
                `;
    ...
    function akadLocation() {
        ...
        if ((navigator.platform.indexOf("iPhone") != -1) ||
            ...
            window.open(
                "maps://www.google.com/maps?daddr=Gg.+I+No.88,+Tirto,+Kec.+Pekalongan+Bar.,+Kota+Pekalongan,+Jawa+Tengah"
            );
        else
            window.open(
                "https://www.google.com/maps?daddr=Gg.+I+No.88,+Tirto,+Kec.+Pekalongan+Bar.,+Kota+Pekalongan,+Jawa+Tengah"
            );
    }
    ...
    $(document).ready(function() {
        ...
        $("#ucapan-form").submit(function(e) {
            ...
            $.post("<?= base_url() ?>/api/post_data", {
                ...
                if (response.success) {
                    const thanksMessage =
                        "<br><div class='alert alert-warning mt-2 text-center'>Terimakasih atas Ucapannya, semoga doa baik anda kembali ke diri anda juga.</div>";
                    $("#ucapan-form").fadeOut("slow", function() {
                        $(this).html(thanksMessage).fadeIn("slow");
                    });
                    loadPage(currentPage);
                } else {
                    alert(
                        'Maaf ucapan anda gagal dikirim, silahkan reload browser / buka tab baru'
                    )
                }
            }, "json");
        });
